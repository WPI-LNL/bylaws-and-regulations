...
\item Absentee ballots will be accepted in the form of written communication containing an ordered list of names, abstain, or no confidence in descending preference, for each office. This written communication should be submitted to the person(s) counting votes in accordance with \cref{itm:votecounters} of this section. Absentee ballots for a given office must be received prior to the end of voting for that position. Absentee ballots will only be counted if the member submitting them is not currently present at the meeting. Absentee ballots shall not count towards quorum.
\item The first nominee to get greater than 50 percent of non-abstaining votes cast for an office will be elected to that office.
...
\item No member shall begin an Independent Study Project related to the club without first consulting the Executive Board.
...
Lens and Lights owns an amateur radio callsign, W1LNL. Use of this callsign is restricted to Active and Alumni members, with permission from the Repeater Manager.
...
\item Special Events
\item DX
\item Additional events or usages at the discretion of the Repeater Manager
\end{itemize}

Note that the W1LNL callsign may not be used for general chat or ragchewing.

The W1LNL callsign does not confer any additional privileges beyond your amateur license. You may not use the W1LNL callsign to operate outside of your license privileges.
Use of the W1LNL callsign is subject to the approval of the Repeater Manager. Members wishing to make use of the callsign should contact the Repeater Manager in advance of their planned usage. Authorization can be revoked at any time by the Repeater Manager or the Executive Board.
...
\begin{enumerate}
    \item Card access is given to members of the club at the discretion of the
        Executive Board and likewise, the Executive Board can revoke any card
        access within its purview. Should a member be found to be misusing their
        access, the Executive Board shall review their access accordingly.
    \item The President shall be responsible for Club card access, both the
        users on all Club-managed card access levels and the access provided by
        all levels. The President shall also be responsible for communicating
        and changes with Campus Card Access in a timely manner
